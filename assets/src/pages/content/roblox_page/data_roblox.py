...
less_1 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/0.png',width=100),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/1.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/3.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/4.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/5.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/6.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/7.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/8.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/9.png',width=200),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/10.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/11.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/12.gif',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('Paint - перекрашивает материал.'),width=700),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/13.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/14.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/15.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_1/16.gif',width=700),margin=ft.margin.only(left=0)),
...
less_2 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_2/1.gif',width=700),margin=ft.margin.only(left=0)),
...
less_3 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_3/1.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_3/2.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_3/3.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_3/4.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_3/5.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_3/6.gif',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('После создания стен, их можно раскрасить, либо задать материал. '),width=700),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_3/7.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_3/8.gif',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('Другой пример - игра - мочи зомби в одном из наших детских центров.'),width=700),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_3/9.gif',width=700),margin=ft.margin.only(left=0)),
    ])
)
...
less_4 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_4/1.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_4/2.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_4/3.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_4/4.gif',width=700),margin=ft.margin.only(left=0)),
...
less_5 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/1.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/2.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/3.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/4.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/5.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/6.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/7.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/8.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/9.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/10.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/11.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/12.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/13.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/14.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/15.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/16.png',width=700),margin=ft.margin.only(left=0)),

        ft.Container(ft.Text(''),width=700),
        # ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_5/',width=700),margin=ft.margin.only(left=0)),
    ])
)
# 6 урок
less_6 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_6/1.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_6/2.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_6/3.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_6/4.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_6/5.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_6/6.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_6/7.png',width=700),margin=ft.margin.only(left=0)),
...
less_7 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/1.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/2.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/3.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/4.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/5.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/6.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/7.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/8.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/9.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_7/10.png',width=700),margin=ft.margin.only(left=0)),
...
less_8 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_8/1.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_8/2.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('2.Снимаем галочку с параметра CanCollide и удаляем скрипт для Teleport2'),width=700),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_8/3.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_8/4.png',width=700),margin=ft.margin.only(left=0)),
...
less_9 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_9/1.png',width=700),margin=ft.margin.only(left=0)),
...
less_10 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_10/1.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_10/2.png',width=700),margin=ft.margin.only(left=0)),
...
less_11 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_11/1.gif',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('Теперь переименуйте Part в b1 и напишите в нем скрипт - \nlocal b1 = game.Workspace.b1'),width=700),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_11/2.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_11/3.gif',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('Застваим блок увеличить высоту до 20, а потом обратно до 1.'),width=700),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_11/4.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_11/5.gif',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_11/6.gif',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text(''),width=700),
...
less_12 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_12/1.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_12/2.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_12/3.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_12/4.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_12/5.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_12/6.png',width=700),margin=ft.margin.only(left=0)),
...
less_13 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_13/1.gif',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text(''),width=700),
...
less_14 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/1.jpg',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/2.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/3.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/4.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('Загружаем 3 картинки по очереди. Каждой даём свое понятное название на анг языке.'),width=700),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/5.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/6.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/7.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/8.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/9.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/10.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('В окне VIEW отключаем видимость интерфейса нажав на кнопку UI Visibility'),width=700),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/11.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/12.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/13.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/14.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('13. Внутри ReplicatedStorage создайте RemoteEvent и переименуйте его в SelectTeam'),width=700),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/15.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/16.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_14/17.png',width=700),margin=ft.margin.only(left=0)),
...
less_15 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_15/1.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_15/2.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_15/3.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_15/4.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='assets/src/pages/content/roblox_page/img/les_15/5.png',width=700),margin=ft.margin.only(left=0)),
