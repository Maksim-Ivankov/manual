...
from assets.src.pages.content.maincraft_page.oglav import Oglav
from assets.src.pages.content.maincraft_page.print_lesson import Print_lesson

class Maincraft_page(ft.UserControl):
    ...
    def print_page(self,page):
        ...
        if page == 'Оглавление': title_print = 'Учебник Майнкрафт'
        else: title_print = 'Учебник Майнкрафт | ' + page
